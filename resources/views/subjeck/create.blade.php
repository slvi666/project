          ...
          <div class="card-body">
            <form action="{{ route('subjects.store') }}" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="class_name" class="form-control rounded-pill px-3 py-2" required>
              </div>

              <div class="mb-3">
                <label for="subject_name" class="form-label">Nama Mata Pelajaran</label>
                <input type="text" name="subject_name" class="form-control rounded-pill px-3 py-2" required>
              </div>

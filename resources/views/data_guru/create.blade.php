<!-- resources/views/data_guru/create.blade.php -->
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Formulir Tambah Data Guru</h3>
              </div>
              <div class="card-body">
                <form action="{{ route('data_guru.store') }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="no_telpon" id="no_telpon" class="form-control @error('no_telpon') is-invalid @enderror" value="{{ old('no_telpon') }}">
                    @error('no_telpon')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
